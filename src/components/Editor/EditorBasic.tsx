...
const EditorBasic = ({ name, content, onChange }: EditorBasicProps) => {
  ...
  return (
    <div className='border rounded-md'>
      ...
      <Divider />
      <EditorContent editor={editor} className='min-h-[2.5rem] overflow-y-auto px-3 py-2 focus:outline-none' />
    </div>
  )
}
